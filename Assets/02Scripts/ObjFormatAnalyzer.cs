...
namespace Hont
{
    public class ObjFormatAnalyzer
    {
        ...
        {
//			Debug.Log ("ObjFormatAnalyzer Analyze content: " + content);

            content = content.Replace('\r', ' ').Replace('\t', ' ');
//			Debug.Log ("ObjFormatAnalyzer Analyze content2: " + content);
...
//			Debug.Log ("ObjFormatAnalyzer Analyze VertexArr: " + VertexArr.Length);
//			Debug.Log ("ObjFormatAnalyzer Analyze VertexNormalArr: " + VertexNormalArr.Length);
//			Debug.Log ("ObjFormatAnalyzer Analyze VertexTextureArr: " + VertexTextureArr.Length);
//			Debug.Log ("ObjFormatAnalyzer Analyze FaceArr: " + FaceArr.Length);
        }
    }
}